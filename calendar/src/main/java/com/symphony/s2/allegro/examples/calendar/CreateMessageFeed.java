 ...
 *
 */
public class CreateMessageFeed extends CommandLineHandler implements Runnable
{
  private static final Logger log_ = LoggerFactory.getLogger(CreateMessageFeed.class);
  ...
  public void run()
  {
    ...
    UpsertFeedRequest.Builder builder = new UpsertFeedRequest.Builder()
        .withName(CalendarApp.MESSAGES_FEED_NAME)
        .withPermissions(permissions)
        .withSubscribeMessages(true)
        ;
  ...
  {
    CreateMessageFeed program = new CreateMessageFeed();
