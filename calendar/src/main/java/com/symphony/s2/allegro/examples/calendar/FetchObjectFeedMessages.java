 ...
 *
 */
public class FetchObjectFeedMessages extends CommandLineHandler implements Runnable
{
   ...
   * Constructor.
   */
  public FetchObjectFeedMessages()
  {
  ...
  {
    FetchObjectFeedMessages program = new FetchObjectFeedMessages();
