...
abstract class Allegro2Example
{
  ...
  /** Allegro client */
  protected final IAllegro2Api allegro2Api_;
   ...
   */
  Allegro2Example(String[] args)
  {
    Allegro2ExampleCommandLineHandler handler = new Allegro2ExampleCommandLineHandler();
    ...
    allegro2Api_ = new Allegro2Api.Builder()
